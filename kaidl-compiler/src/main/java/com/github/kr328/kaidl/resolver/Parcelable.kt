      ...
      loadResolver().run {
        ...
        when (clazz.qualifiedName!!.asString()) {
            ...
            when {
              ...
              clazz.getSuperByName(IINTERFACE) != null -> ParcelableType.AidlInterface
              clazz.getSuperByName(PARCELABLE) != null -> ParcelableType.Parcelable
              clazz.getSuperByName(SERIALIZABLE) != null -> ParcelableType.Serializable
              clazz.classKind == ClassKind.ENUM_CLASS -> ParcelableType.Enum
              else -> throw IllegalArgumentException("unsupported type $canonicalName")
            }
        }
      }
    }
